...
class _Initial implements InvitationState {
  const _Initial();
...
class _Submitting implements InvitationState {
  const _Submitting();
...
@override
String toString() {
  return 'InvitationState.submitting()';
}
...
class _Success implements InvitationState {
  const _Success();
...
class _Error implements InvitationState {
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $InvitationStateCopyWith<$Res> {
