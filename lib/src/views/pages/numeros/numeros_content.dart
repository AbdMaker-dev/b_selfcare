...
class _NumerosContentState extends State<NumerosContent> {
            ...
            if (isLoading && numbers.isEmpty)
              ...
              AppTable(
                ...
                source: SourceNumeros(
                  rows: numbers,
                  onDetail: (n) => DetailNumero.show(context, numero: n, flotteNumberCubit: _cubit),
                  onAssign: (n) => FormAssignNumero.show(context, numero: n, flotteNumberCubit: _cubit),
                  onSuspend: (n) => ConfirmSuspendNumero.show(context, numero: n, flotteNumberCubit: _cubit),
                  onReactivate: (n) {
